...
<div class="page-header"><div><h1 class="page-title">Reports</h1><p class="page-subtitle mb-0">HR analytics and summaries</p></div></div>
<div class="px-4 pb-4">
...
<div class="col-md-3"><div class="card-modern"><div class="card-body-modern"><div class="text-muted small mb-1">Active Employees</div><div class="fw-bold" style="font-size:1.6rem;color:#059669;"><?php echo $stats['active_employees']; ?></div></div></div></div>
...
<div class="col-md-3"><div class="card-modern"><div class="card-body-modern"><div class="text-muted small mb-1">Candidates</div><div class="fw-bold" style="font-size:1.6rem;color:#ea580c;"><?php echo $stats['total_candidates']; ?></div></div></div></div>
...
<div class="col-md-3"><div class="card-modern"><div class="card-body-modern"><div class="text-muted small mb-1">Pending Tasks</div><div class="fw-bold" style="font-size:1.6rem;color:#d97706;"><?php echo $stats['pending_tasks']; ?></div></div></div></div>
</div>
</div></div>
