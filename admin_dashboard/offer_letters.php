...
require_admin();
$user = current_user();
$data = $pdo->query("SELECT c.*, jp.title as job_title FROM candidates c LEFT JOIN job_postings jp ON c.job_posting_id = jp.id WHERE c.status='offer_sent' ORDER BY c.applied_at DESC")->fetchAll();
?>
...
<div class="page-header"><div><h1 class="page-title">Offer Letters</h1><p class="page-subtitle mb-0">Offer Letters Management</p></div></div>
<div class="px-4 pb-4">
