...
<div class="page-header"><div><h1 class="page-title">HR Reports</h1><p class="page-subtitle mb-0">Workforce overview</p></div></div>
<div class="px-4 pb-4">
<div class="card-modern"><div class="card-body-modern" style="padding:0;"><div class="table-responsive"><table class="table-modern" style="margin:0;"><thead style="background:#0f172a;"><tr><th>Employee</th><th>Department</th><th>Role</th><th>Salary</th><th>Type</th><th>Status</th></tr></thead><tbody>
...
<tr><td class="fw-semibold small"><?php echo htmlspecialchars($row['emp_name']); ?></td><td><?php echo htmlspecialchars($row['dept']??'-'); ?></td><td><?php echo htmlspecialchars($row['role']??'-'); ?></td><td>₦<?php echo number_format($row['salary'],2); ?></td><td><?php echo ucfirst($row['employment_type']); ?></td><td><span class="status-badge <?php echo $sc; ?>"><?php echo ucfirst($row['status']); ?></span></td></tr>
