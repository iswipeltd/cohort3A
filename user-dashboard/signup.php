...
<head>
    <meta charset="utf-8">
    <title>Sign Up | ADEEEEE Employee</title>
...
<div class="login-card">
    ...
    <div class="login-body">
        ...
        <p class="text-muted mb-4" style="font-size:0.85rem;">Join your organization's HR portal</p>
        ...
        <?php if ($success): ?><div class="alert alert-success d-flex align-items-center py-2" style="font-size:0.85rem;border-radius:10px;"><i class="fa-solid fa-circle-check me-2"></i><?php echo htmlspecialchars($success); ?></div><?php endif; ?>
        <form action="/HRSuite/process/register.php" method="POST">
            <div class="row g-2 mb-3">
                <div class="col-6"><label class="form-label small fw-semibold text-muted">First Name</label><input type="text" name="first_name" class="form-control form-control-login" placeholder="John" required></div>
                <div class="col-6"><label class="form-label small fw-semibold text-muted">Last Name</label><input type="text" name="last_name" class="form-control form-control-login" placeholder="Doe" required></div>
            </div>
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="email" name="email" class="form-control form-control-login border-start-0" style="border-radius:0 10px 10px 0;" placeholder="john.doe@company.com" required>
                </div>
            </div>
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="password" name="password" class="form-control form-control-login border-start-0" style="border-radius:0 10px 10px 0;" placeholder="Min. 6 characters" required>
                </div>
            </div>
            <div class="mb-4">
                ...
                <div class="input-group">
                    <span class="input-group-text bg-light border-end-0" style="border-radius:10px 0 0 10px;"><i class="fa-solid fa-lock text-muted" style="font-size:0.8rem;"></i></span>
                    <input type="password" name="confirm_password" class="form-control form-control-login border-start-0" style="border-radius:0 10px 10px 0;" placeholder="Repeat password" required>
                </div>
            </div>
            <button type="submit" class="btn btn-login">Create Account</button>
        </form>
        <p class="text-center text-muted small mt-4 mb-0">Already have an account? <a href="/HRSuite/user-dashboard/signin.php" class="fw-semibold text-decoration-none" style="color:#2563eb;">Sign In</a></p>
