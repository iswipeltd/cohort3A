...
unset($_SESSION['error'], $_SESSION['success'], $_SESSION['reset_link']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <title>Forgot Password | ADEEEEE</title>
...
<div class="login-card">
    ...
    <div class="login-body">
        ...
        <?php if ($resetLink): ?>
        <div class="alert alert-warning py-3" style="border-radius:10px;font-size:0.85rem;">
            <p class="mb-2 fw-semibold"><i class="fa-solid fa-triangle-exclamation me-2"></i>Reset Link (click or copy):</p>
            <a href="<?php echo htmlspecialchars($resetLink); ?>" class="d-block text-break fw-bold" style="color:#2563eb;"><?php echo htmlspecialchars($resetLink); ?></a>
        </div>
        <?php endif; ?>
        <form action="/HRSuite/process/forgot_password.php" method="POST">
            <div class="mb-4">
        ...
        <p class="text-center text-muted small mt-4 mb-0">Remember your password? <a href="/HRSuite/user-dashboard/signin.php" class="fw-semibold text-decoration-none" style="color:#2563eb;">Sign In</a></p>
