...
<head><meta charset="utf-8"><title>Set New Password | ADEEEEE</title>
...
<h5 class="fw-bold mb-1">First time login</h5>
...
<form action="/HRSuite/process/first_login_password.php" method="POST">
...
<button type="submit" class="btn btn-login">Set Password <i class="fa-solid fa-check ms-2"></i></button>
</form>
</div>
</div>
</body></html>
