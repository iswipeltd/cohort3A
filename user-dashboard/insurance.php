...
<div class="page-header"><div><h1 class="page-title">Insurance</h1><p class="page-subtitle mb-0">Employment insurance details</p></div></div>
<div class="px-4 pb-4">
...
<div class="col-md-12"><div class="p-3" style="background:#f0fdf4;border-radius:10px;"><div class="text-muted small">Insurance Status</div><div class="fw-bold" style="color:#047857;">Covered (<?php echo ucfirst($emp['status']??'Active'); ?>)</div></div></div>
</div>
<?php else: ?>
<div class="text-center py-5 text-muted">No insurance details</div>
<?php endif; ?>
</div></div></div></div></div>
