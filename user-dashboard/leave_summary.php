...
<p class="page-subtitle mb-0">All leave activity</p>
</div>
</div>
<div class="px-4 pb-4">
...
<tr>
<td class="fw-semibold small"><?php echo htmlspecialchars($row['leave_type']); ?></td>
...
<tr><td colspan="5" class="text-center text-muted py-5">No leave records</td></tr>
<?php endif; ?>
</tbody>
</table>
</div>
