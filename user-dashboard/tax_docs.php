...
require_auth();
$user = current_user();
$data = $pdo->query("SELECT * FROM documents WHERE type='tax_form' ORDER BY uploaded_at DESC")->fetchAll();
?>
...
<div class="page-header"><div><h1 class="page-title">Tax Documents</h1><p class="page-subtitle mb-0">Tax and payroll documents</p></div></div>
<div class="px-4 pb-4">
...
<?php endforeach; if(empty($data)): ?><tr><td colspan="4" class="text-center text-muted py-5">No tax documents</td></tr><?php endif; ?>
